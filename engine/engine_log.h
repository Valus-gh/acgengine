...
public: //
	...
	{
		none,
		///< No logging, used for levels
		error,
		///< Error message
		warning,
		///< Warning message
		plain,
		///< Clean simple output message
		info,
		///< Hint or additional information (slightly verbose)
		debug,
		///< Debugging information (very verbose)
		detail,
		///< Debugging information (extremely verbose)
		last,
		///< Terminator
	};
