 ...
 */
ENG_API Eng::Shader::Shader(const std::string& name) : Eng::Object(name),
                                                       reserved(std::make_unique<Eng::Shader::Reserved>())
{
	ENG_LOG_DEBUG("[+]");
}
...
bool ENG_API Eng::Shader::init()
{
	...
	switch (this->getType())
	{
	case Eng::Shader::Type::vertex: glKind = GL_VERTEX_SHADER;
		break;
	case Eng::Shader::Type::tessellation_ctrl: glKind = GL_TESS_CONTROL_SHADER;
		break;
	case Eng::Shader::Type::tessellation_eval: glKind = GL_TESS_EVALUATION_SHADER;
		break;
	case Eng::Shader::Type::geometry: glKind = GL_GEOMETRY_SHADER;
		break;
	case Eng::Shader::Type::fragment: glKind = GL_FRAGMENT_SHADER;
		break;
	case Eng::Shader::Type::compute: glKind = GL_COMPUTE_SHADER;
		break;
	default:
