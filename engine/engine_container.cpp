 ...
 */
ENG_API Eng::Container::Container(const std::string& name) : Eng::Object(name),
                                                             reserved(std::make_unique<Eng::Container::Reserved>())
{
	ENG_LOG_DETAIL("[+]");
}
 ...
 * Move constructor.
 */
ENG_API Eng::Container::Container(Container&& other) : Eng::Object(std::move(other)),
